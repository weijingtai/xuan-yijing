...
class _GuaDetailsPageState extends State<GuaDetailsPage> with TickerProviderStateMixin {
  ...
  final String content = "梅花易数可以产生声音、方位、时间、动静、地理、天时、人物、颜色、动植物等自然界或人类社会中的一切感知的事物异相，作为预测其发展趋势的方法。从而可洞悉其先机达到知己知彼百战百胜的效果。"
                ...
                child: Listener(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        zhouYiGua("010101","火水未济","本", GuaSizeType.large),
                      ],
                    )
                  ),
                ),
                    ...
                    child: SingleChildScrollView(
                        child: Column(
                            ...
                            children: List.generate(8, (index) => Container(
                              ...
                              child: Column(
                                children: [
                                  Container(height:24,alignment: Alignment.center,child: Text("Book Name"),),
                                  Container(
                                      ...
                                      child:ListView.builder(itemBuilder: (context, index) =>InkWell(
                                        ...
                                        child: Card(
                                          child: Container(
                                            ...
                                            padding: EdgeInsets.only(left: 4,right: 0,top: 8,bottom: 4),
                                      ...
                                      ),itemCount: ["象","彖","初","二","三","四","五","上"].length,scrollDirection: Axis.horizontal,)
                                  )
                                ],
                              )
                            ),)
  ...
  Widget zhouYiGua(String guaBinaryContent,String guaName,String guaType, GuaSizeType size) {
    ...
    List<Widget> yaoWidgetList = guaBinaryIter.asMap().entries.map((entry) => zhouYiYao(entry.value==1, yaoChildWidth, yaoChildHeight, entry.key)).toList();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          MouseRegion(
            onHover: (event){
              ...
              Timer.periodic(Duration(seconds: 3), (timer) {
                if (lastPenHoverAt.add(Duration(seconds:3)).isBefore(DateTime.now())){
          ...
          Container(
              color: Colors.blue,
              child: ZhouYiGuaWidget(guaBinaryContent: guaBinaryContent,fullGuaName: guaName,)),
          Row(
            crossAxisAlignment: CrossAxisAlignment.center,
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
                ...
                child: InkWell(
                  ...
                  child:Animate(
                    ...
                    child: Container(
                      ...
                      child: MiniZhouYiGuaWidget(guaBinaryContent: '101010',guaName: '水火既济',guaExtraName: '错'))
...
/*                  child: Container(
              ...
              Container(
                  ...
                  padding: EdgeInsets.only(top: 2),
                  child: MiniZhouYiGuaWidget(guaBinaryContent: '101010',guaName: '水火既济',guaExtraName: '综')),
              Container(
                  decoration: BoxDecoration(
                    // color: Colors.red,
                    borderRadius: BorderRadius.circular(2),
                  ...
                  padding: EdgeInsets.only(top: 2),
                  child: MiniZhouYiGuaWidget(guaBinaryContent: '101010',guaName: '水火既济',guaExtraName: '互'))
            ],
          ),
          Container(
              height: 80,
              child:ListView(
                  ...
                  children: [
                    Tuple4<String,String,String,List<int>>('101101','离为火','离宫纯卦',[]),
                    Tuple4<String,String,String,List<int>>('001101','火山旅','初爻变',[0]),
                    Tuple4<String,String,String,List<int>>('011101','火风鼎','二爻变',[0,1]),
                    Tuple4<String,String,String,List<int>>('010101','火水未济','三爻变',[0,1,2]),
                    Tuple4<String,String,String,List<int>>('010001','山水蒙','四爻变',[0,1,2,3]),
                    Tuple4<String,String,String,List<int>>('010011','风水涣','五爻变',[0,1,2,3,4]),
                    Tuple4<String,String,String,List<int>>('010111','天水讼','游魂卦',[0,1,2,4]),
                    Tuple4<String,String,String,List<int>>('101111','天火同人','归魂卦',[4])
                  ].map((e) => Card(
                    elevation: e.item1==guaBinaryContent?2:0,
                      child: Container(
                        color: e.item1==guaBinaryContent?Color.fromRGBO(51, 102, 153, .1):Colors.transparent,
                          child: TinyZhouYiGuaWidget(guaBinaryContent: e.item1,guaName: e.item2,guaExtraName:e.item3, height: 3,width: 24,yaoInterval: 2,changedYaoIndexList:e.item4))
                  )).toList()
              )
          ),
          Container(
                    ...
                    Tuple2<String,String>('101111','天火同人'),
                      ...
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8),
                          child: TinyZhouYiGuaWidget(guaBinaryContent: e.item1,guaName: e.item2,guaExtraName:null, height: 3,width: 24,yaoInterval: 2))
                  )).toList()
              )
          )
