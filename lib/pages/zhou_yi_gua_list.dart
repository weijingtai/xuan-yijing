...
import 'package:my_flutter/pages/zhou_yi_gua_hit_details.dart';
...
class _ZhouYiGuaListPageState extends State<ZhouYiGuaListPage> {
              ...
              builder: (_) {
                return ValueListenableBuilder(
                    ...
                    builder: (ctx,zhouYi,child){
                      return zhouYi == null?child!:ZhouYiGuaPart(zhouYi: zhouYi,);
                    },
                        ...
                        builder: (ctx,zhouYi,child){
                          ...
                          return AnimatedSwitcher(
                              ...
                              transitionBuilder: (child, animation) => SlideTransition(
                                position: Tween<Offset>(begin: Offset(0, 1.2), end: Offset(0, 0))
                                    .animate(animation),
                                child: child,
                              ),
                              child: zhouYi == null?child!:Container(
                                  key: Key('SecondaryBody ${zhouYi.gua}'),
                                  color: Color.fromRGBO(255, 251, 240, 1),
                                  child:ZhouYiGuaPart(zhouYi: zhouYi,)
                              ));
                          return zhouYi == null?child!:ZhouYiGuaPart(zhouYi: zhouYi,);
                        },
                        child: Container(
  ...
  Widget guaListWithModel(){
    return ListView(
        children: _zhouYiAllGuaList.map((e) => Card(
          child: InkWell(
            onDoubleTap: (){
            ...
            onTap: (){
              if (_largeRightSideZhouYiNotifier.value != null && _largeRightSideZhouYiNotifier.value!.name == e.name){
                _largeRightSideZhouYiNotifier.value = null;
              }else{
                ...
                leading: Hero(
                  ...
                  child: Container(
                    ...
                    child: TinyZhouYiGuaWidget(
                      guaBinaryContent: e.binary.split("").reversed.join(""),
                      guaName: "",
                      height: 4,
                      width: 30,
                      yaoInterval: 1,
