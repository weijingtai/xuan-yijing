...
class ZhouYiGuaDetailsPage extends StatefulWidget {
  ...
  ZhouYiGuaDetailsPage(Map<String, dynamic> args,
      {Key? key, this.cardWidth = 256})
      : super(key: key) {
    zhouYi = args["zhouYi"];
  }
...
class _ZhouYiGuaDetailsPageState extends State<ZhouYiGuaDetailsPage>
  ...
  ValueNotifier<Tuple2<ZhouyiZhuBooks, String>?> displayZhuNotifier =
      ValueNotifier(null);
                          ...
                          child: Container(
                            ...
                            child: BackdropFilter(
                              ...
                              child: Column(
                                ...
                                children: [
                                  buildLargeCard(
                                      displayZhu.item1, displayZhu.item2),
                                ],
                              ),
                            ),
                          ),
        ...
        config: <Breakpoint, SlotLayoutConfig>{
          Breakpoints.small: SlotLayout.from(
              ...
              builder: (_) => CustomScrollView(slivers: [
                    SliverToBoxAdapter(
                      child: zhouYiGua(binaryContent, widget.zhouYi.name,
                          GuaSizeType.large, widget.zhouYi.fullname),
                    ),
                    SliverToBoxAdapter(
                      child: zhuPart(),
                    ),
  ...
  Widget eachZhuCard(ZhouyiZhuBooks book, ZhouYiGuaZhu? guaZhu,
      List<ZhouYiYaoZhu> yaoZhuList) {
    return Container(
      ...
      child: Column(
        children: [
          Container(
              ...
              alignment: Alignment.center,
              child:
                  Text("（${book.bookage}·${book.bookauth}）《${book.bookname}》")),
          Expanded(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: 72, color: Colors.black12),
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: content == null || content.isEmpty
                                ...
                                : SelectableText.rich(
                                    ...
                                    contextMenuBuilder: content == null
                                        ? null
                                        : (arg1, arg2) => contentSelected(
                                            arg1, arg2, content!),
                                    onTap: () {
                                      popupYaoZhu(book, content!);
                                    },
  ...
  Widget buildLargeCard(ZhouyiZhuBooks book, String content) {
    ...
    return Container(
              ...
              child: InkWell(
                ...
                Container(
                  ...
                  child: SelectableText.rich(
                    ...
                    contextMenuBuilder: (arg1, arg2) =>
                        contentSelected(arg1, arg2, content),
                  ),
                ),
              ])),
            ))
        .animate()
        .scaleXY(
            duration: Duration(milliseconds: 800), curve: Curves.easeInOutCirc);
  }
  ...
  Widget zhouYiGua(String guaBinaryContent, String shortname, GuaSizeType size,
      String fullname) {
    return Container(
      alignment: Alignment.center,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Hero(
                        ...
                        child: ZhouYiGuaWidget(
                            guaBinaryContent:
                                guaBinaryContent.split("").reversed.join(""),
                            selectedIndexNotifier: _selectedYaoXiangIndex)),
                    Container(
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                              ...
                              child: ValueListenableBuilder(
                                ...
                                builder: (context, i, child) {
                                  ...
                                  return AnimatedContainer(
                                    ...
                                    child:
                                        guaXiangWidget(widget.zhouYi.xiang, 2),
                                  );
                                },
                              ),
                            ),
                    ...
                    FutureBuilder<List<ZhouYiGuaYao>>(
                        future: Get.find<MyDatabase>()
                            .findAllGuaYao(guaBinaryContent),
                        builder: (ctx, data) {
                          if (data.hasData) {
                            if (data.data == null) {
                              return Container(
                                  ...
                                  alignment: Alignment.center,
                                  child: Text(
                                      "error for ${widget.zhouYi.fullname}"));
                            }
            ...
            FutureBuilder(
                future: Get.find<MyDatabase>()
                    .findAllSingleGuaZhu(widget.zhouYi.binary),
                builder:
  ...
  Widget _buildYaoXiang(List<ZhouYiGuaYao> yaoList) {
    ...
    Iterable<Widget> it = yaoList.map((e) {
      ...
      counter++;
      return _buildEachGuaYaoCiXiang(
          counter, "${e.yaoName}：", yaoContent, xiangName, xiangContent);
    });
  ...
  Widget _buildEachGuaYaoCiXiang(int index, String yaoName, String yaoContent,
      String xiangName, String xiangContent) {
    return GestureDetector(
      onTap: () {
        showYaoCard(index);
      },
  ...
  void yaoZhuScrollTo(int index) {
    _scrollController.animateTo(index * (widget.cardWidth + 8),
  ...
  Widget _buildCuoZongFuZa(ZhouYi gua, String guaType) {
    ...
    String guaContent =
        gua.gua.replaceAll("：", " ").replaceAll("。", "").replaceAll("，", " ");
          ...
          child: InkWell(
              onTap: () {
                if (infoPopupControllerMapper.containsKey(guaType)) {
                  infoPopupControllerMapper[guaType]!.isShowing
                      ? infoPopupControllerMapper[guaType]!.dismissInfoPopup()
                      : infoPopupControllerMapper[guaType]!.show();
                }
              },
              onDoubleTap: () {
              ...
              child: MiniZhouYiGuaWidget(
                  guaBinaryContent: gua.binary.split("").reversed.join(""),
                  guaName: gua.fullname,
                  guaExtraName: guaType))),
    );
  }
    ...
    return MouseRegion(
        onHover: (event) {
          if (lastEnterHoverTimestamp == null) {
            ...
            var hoverOnMillisCounter = event.timeStamp.inMilliseconds -
        ...
        child: InkWell(
            ...
            child: Animate(
                ...
                child: Container(
                    ...
                    padding: EdgeInsets.only(top: 2),
                    child: MiniZhouYiGuaWidget(
                        guaBinaryContent: cuoBinaryContent,
                        guaName: cuoFullname,
                        guaExtraName: '错')))));
  }
...
//  八宫世卦
    ...
    return FutureBuilder(
      future: Future.wait([
        DefaultAssetBundle.of(context)
            .loadString("packages/yijing/resources/db/eight_gong_gua_info.json"),
        DefaultAssetBundle.of(context)
      ...
      builder: (ctx, snap) {
        if (snap.hasData) {
          Map<String, dynamic> eightGuaInfo =
              json.decode(snap.data![0]) as Map<String, dynamic>;
          Map<String, dynamic> guaFullnameBinaryIndexDB =
              json.decode(snap.data![1]) as Map<String, dynamic>;
          ...
          var counter = 0;
          Iterable<Tuple4<String, String, String, List<int>>> allGuaList =
              gongGuaList.map((e) {
          ...
          var guaWidgetList = allGuaList
              .map((e) => Card(
                  elevation: e.item2 == fullname ? 2 : 0,
                  child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(4),
                        color: e.item2 == fullname
                            ? Color.fromRGBO(51, 102, 153, .4)
                            : Color.fromRGBO(23, 124, 176, .1),
                      ),
  ...
  Widget sixteenChangeWidget(String fullname) {
    return FutureBuilder(
      future: Future.wait([
        DefaultAssetBundle.of(context)
            .loadString("packages/yijing/resources/db/ba_gong_sixteen_change_info.json"),
        DefaultAssetBundle.of(context)
            .loadString("packages/yijing/resources/db/gua_fullname_binary_index.json"),
      ]),
      builder: (ctx, snap) {
        if (snap.hasData) {
          ...
          var pureGuaShortname = eightGuaInfo["index"][fullname];
          List<dynamic> gongGuaList =
              eightGuaInfo["content"][pureGuaShortname[1]];
          // print(json.encode(gongGuaList));
              ...
              .map((e) => Card(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(4),
                        color: e.item2 == fullname
                            ? Color.fromRGBO(74, 66, 102, .4)
                            : Color.fromRGBO(6, 82, 121, .1),
                      ),
                      child: TinyZhouYiGuaWidget(
                          guaBinaryContent: e.item1,
                          guaName: e.item2,
